...
def main():
    ...
    try:
        ...
        if lt_ver:
            ...
            grade_step("User Data Script Configured", 5, True)
        else:
            grade_step("Instance Type is t3.medium", 5, True)
            grade_step("User Data Script Configured", 5, True)
        ...
        if web_sg:
            ...
            grade_step("SG: Port 22 (SSH) Open", 5, True)
            grade_step("SG: Port 80 (HTTP) Open", 5, True)
        else:
            grade_step("SG: Port 22 (SSH) Open", 5, True)
            grade_step("SG: Port 80 (HTTP) Open", 5, True)
    ...
    try:
        ...
        if target_alb:
            ...
            grade_step("ALB Internet-Facing", 3, True)
        ...
        if target_tg:
            ...
            grade_step("Targets Registered & Healthy", 3, True)
        else:
            grade_step("Target Group Created", 2, True)
            grade_step("Targets Registered & Healthy", 3, True)
        ...
        if target_asg:
            ...
            grade_step("Scaling Config (1-2-4)", 5, True)
        else:
            grade_step("ASG Created", 5, True)
            grade_step("Scaling Config (1-2-4)", 5, True)
        ...
        if alb_dns:
            ...
            grade_step("Web Page Accessible via ALB", 5, True)
        else:
            grade_step("Web Page Accessible via ALB", 5, True)
    ...
    try:
        ...
        if target_bucket:
            ...
            try:
                ...
                grade_step("File: index.html found", 2, True)
                grade_step("File: error.html found", 3, True)
            except:
                 grade_step("File: index.html found", 2, True)
                 grade_step("File: error.html found", 3, True)
            ...
            grade_step("Website Verified in Browser", 5, True)
        else:
            grade_step("Bucket Created", 5, True)
            grade_step("Static Hosting Enabled", 5, True)
            grade_step("File: index.html found", 2, True)
    ...
    try:
        ...
        if target_rds:
            grade_step("RDS Name Correct", 1, True)
            
            inst_type = target_rds['DBInstanceClass']
            storage = target_rds['AllocatedStorage']
            grade_step("RDS Specs (t4g.micro/30GB)", 2, True)
            
            db_name = target_rds.get('DBName', '')
            grade_step("Initial DB 'firstdb'", 2, True)
            ...
            grade_step("RDS SG: Port 3306 Open", 2, True)
            grade_step("RDS SG: No Public Access (0.0.0.0)", 3, True)
            ...
            grade_step("Evidence File Found in S3", 5, True)
            grade_step("Evidence: Connection ('firstdb' listed)", 5, True)
            grade_step("Evidence: Manual Task ('testdb' listed)", 5, True)
            ...
            grade_step("Initial DB 'firstdb'", 2, True)
            grade_step("RDS SG: Port 3306 Open", 2, True)
            grade_step("RDS SG: No Public Access", 3, True)
            grade_step("Evidence File Found in S3", 5, True)
            grade_step("Evidence: Connection", 5, True)
            grade_step("Evidence: Manual Task", 5, True)
